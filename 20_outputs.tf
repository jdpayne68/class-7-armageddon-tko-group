...
output "vpcend_ssm_id" {
  value = aws_vpc_endpoint.vpcend_ssm.id
}

output "vpcend_logs_id" {
  value = aws_vpc_endpoint.vpcend_logs.id
}

output "vpcend_secrets_id" {
  value = aws_vpc_endpoint.vpcend_secrets.id
}

output "vpcend_s3_id" {
  value = aws_vpc_endpoint.vpcend_s3_gw.id
}
