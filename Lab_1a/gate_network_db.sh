...
usage() {
  cat <<EOF
Usage:
  REGION=us-east-1 INSTANCE_ID=i-03a380cd58523d202 DB_ID=lab-mysql-az7ux ./gate_network_db.sh
...
Examples:
  ...
  CHECK_PRIVATE_SUBNETS=true REGION=us-east-1 INSTANCE_ID=i-03a380cd58523d202 DB_ID=lab-mysql-az7ux ./gate_network_db.sh
EOF
}
